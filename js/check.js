...
window.onload = function () {
  ...
  if (localStorage.getItem("Session_ID")) {
    try {
      ...
      try {
        var b = new WebSocket(a.Websocket);
      } catch (a) {
        f("websocket url is not valid !");
        window.location.href = "popup.html";
      }
      b.onerror = function (a) {
        f("error while connect with ws");
        window.location.href = "popup.html";
      };
      b.onmessage = function (c) {
        return h.asyncExecutePromiseGeneratorProgram(function (d) {
          switch (d.nextAddress) {
            case 1:
              c = JSON.parse(c.data);
              if (c.Status == "Username&PassWord") {
              ...
              localStorage.setItem("Language", JSON.stringify(c.Data));
              f("Check complete. Redirecting in 5 seconds.");
              return d.yield(new Promise(function (a) {
                return setTimeout(a, 5000);
              }), 4);
            case 4:
            ...
            case 2:
              ...
              f("Session_ID is not valid with code: " + c.Code);
              return d.yield(new Promise(function (a) {
